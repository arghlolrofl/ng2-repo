...
@Component({
    selector: 'fp-administration-account-invoice-table-paging',
    templateUrl: 'assets/templates/administration/invoices/account-invoice.table.paging.html',
    styles: [
...
export default class AccountInvoiceTablePagingComponent {
    //#region Input
